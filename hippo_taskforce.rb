...
get '/' do
  <<-HTML
    ...
    <body style="background-color: ##eeeeef; color: #503e2b;">
      <div style="font-size:16px; font-family: 'Lucida Grande','Lucida Sans Unicode',Helvetica,Arial,sans-serif; margin:0 auto; width:904px; text-align: center;">
